...
--
--   Navigation keymaps (the `keys` table below):
  ...
  keys = {
    {
      ...
      desc = "Fold: toggle current function/method (or all methods of a class)",
    },
    {
      "<leader>za",
      function()
      ...
      desc = "Fold: toggle entire file (collapse/expand all)",
    },
    {
      "<leader>zo",
      function()
